...
import drinkDB from "../../assets/projects/drink-db-gui.png";
        ...
        {projectData.map((project) => (
          ...
          >
            <div className="cardTitle">
              ...
              <div className="row">
                <div>
                  <a className="app" href={`${project.app}`} target="_blank">
...
const projectData = [
  ...
  {
    img: drinkDB,
    title: "Drink Database GUI",
    app: "https://drink-db-gui-d5fe0e771612.herokuapp.com/",
    repo: "https://github.com/mrgreen12375/drink-db-gui",
    info: "Cocktail Database Management",
  },
  {
    img: flags,
    title: 'Flags "R" Us',
